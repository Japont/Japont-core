...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _extendableBuiltin(e){function t(){var t=(0,_construct2.default)(e,(0,_from2.default)(arguments));return(0,_setPrototypeOf2.default)(t,(0,_getPrototypeOf2.default)(this)),t}return t.prototype=(0,_create2.default)(e.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),_setPrototypeOf2.default?(0,_setPrototypeOf2.default)(t,e):t.__proto__=e,t}var _create=require("babel-runtime/core-js/object/create"),_create2=_interopRequireDefault(_create),_setPrototypeOf=require("babel-runtime/core-js/object/set-prototype-of"),_setPrototypeOf2=_interopRequireDefault(_setPrototypeOf),_construct=require("babel-runtime/core-js/reflect/construct"),_construct2=_interopRequireDefault(_construct),_keys=require("babel-runtime/core-js/object/keys"),_keys2=_interopRequireDefault(_keys),_promise=require("babel-runtime/core-js/promise"),_promise2=_interopRequireDefault(_promise),_stringify=require("babel-runtime/core-js/json/stringify"),_stringify2=_interopRequireDefault(_stringify),_from=require("babel-runtime/core-js/array/from"),_from2=_interopRequireDefault(_from),_getPrototypeOf=require("babel-runtime/core-js/object/get-prototype-of"),_getPrototypeOf2=_interopRequireDefault(_getPrototypeOf),_classCallCheck2=require("babel-runtime/helpers/classCallCheck"),_classCallCheck3=_interopRequireDefault(_classCallCheck2),_createClass2=require("babel-runtime/helpers/createClass"),_createClass3=_interopRequireDefault(_createClass2),_possibleConstructorReturn2=require("babel-runtime/helpers/possibleConstructorReturn"),_possibleConstructorReturn3=_interopRequireDefault(_possibleConstructorReturn2),_inherits2=require("babel-runtime/helpers/inherits"),_inherits3=_interopRequireDefault(_inherits2),_isReady=require("./lib/is-ready"),_isReady2=_interopRequireDefault(_isReady),_es6Promise=require("es6-promise");require("whatwg-fetch"),(0,_es6Promise.polyfill)();var HTMLJapontElement=function(e){function t(){return(0,_classCallCheck3.default)(this,t),(0,_possibleConstructorReturn3.default)(this,(0,_getPrototypeOf2.default)(t).apply(this,arguments))}return(0,_inherits3.default)(t,e),(0,_createClass3.default)(t,[{key:"createdCallback",value:function(){this._attached=!1}},{key:"attachedCallback",value:function(){var e=this;this._attached=!0;var t=this.getAttribute("src"),r=this.getAttribute("selector"),n=this.getAttribute("alias");t&&(0,_isReady2.default)().then(function(){e._sendRequest(t,r,n)})}},{key:"detachedCallback",value:function(){this._attached=!1,this.fontElement&&this.fontElement.parentNode.removeChild(this.fontElement),this.styleElement&&this.styleElement.parentNode.removeChild(this.styleElement),this.fontElement=this.styleElement=null}},{key:"attributeChangedCallback",value:function(e,t,r){var n=this;if(this._attached){var i=this.getAttribute("src"),o=this.getAttribute("selector"),s=this.getAttribute("alias");"alias"===e?this._setFont(s,o):"src"!==e&&"selector"!==e||(0,_isReady2.default)().then(function(){n._sendRequest(i,o,s)})}}},{key:"reload",value:function(){var e=this,t=this.getAttribute("src"),r=this.getAttribute("selector"),n=this.getAttribute("alias");t&&(0,_isReady2.default)().then(function(){e._sendRequest(t,r,n)})}},{key:"_sendRequest",value:function(e){var t=this,r=arguments.length<=1||void 0===arguments[1]?"*":arguments[1],n=arguments.length<=2||void 0===arguments[2]?"":arguments[2];if(e){var i=r?(0,_from2.default)(document.querySelectorAll(r)):[document.documentElement];if(!i||0===i.length){var o=new Error('Selector "'+r+'" is not matched.');throw this._emit("error",o),o}var s=i.map(function(e){return e.textContent}).join("").replace(/[\r\n]/g,""),a=this._uniqueChars(s);fetch("//{{HOST}}/font.css",{method:"POST",mode:"cors",headers:{"Content-Type":"application/json"},body:(0,_stringify2.default)({text:a.join(""),fontName:e,fontFamily:n})}).then(function(e){if(200!==e.status){var r=new Error("Can't read font file. : "+e.statusText);return t._emit("error",r),_promise2.default.reject(r)}return e.text()}).then(function(e){t.fontElement&&t.fontElement.parentNode.removeChild(t.fontElement),t.fontName=e.split("\n")[1];var i=document.createElement("style"),o=document.createTextNode(e);i.setAttribute("class","japont-face"),i.appendChild(o),t.fontElement=i,t.appendChild(i),t._emit("load"),t._setFont(n,r)})}}},{key:"_setFont",value:function(e,t){if(this.fontElement){var r=this.fontElement.textContent;e=e||this.fontName||"undefined";var n=r.replace(/font-family: '[^']*'/,"font-family: '"+e+"'");this.fontElement.textContent=n}this.styleElement&&this.styleElement.parentNode.removeChild(this.styleElement);var i=t+' { font-family: "'+e+'"; }',o=document.createElement("style"),s=document.createTextNode(i);o.setAttribute("class","japont-face"),o.appendChild(s),this.styleElement=o,this.appendChild(o)}},{key:"_emit",value:function(e,t){if("error"===e){var r=new ErrorEvent("error",{error:t,message:t.message});this.dispatchEvent(r)}else{var n=new Event(e,{bubbles:!1,cancelable:!1});this.dispatchEvent(n)}}},{key:"_uniqueChars",value:function(e){for(var t=e.split(""),r={},n=t.length,i=0;i<n;i++)r[t[i]]=1;return(0,_keys2.default)(r)}}]),t}(_extendableBuiltin(HTMLElement));document.registerElement("japont-config",HTMLJapontElement),window.HTMLJapontElement=HTMLJapontElement;
},{"./lib/is-ready":2,"babel-runtime/core-js/array/from":3,"babel-runtime/core-js/json/stringify":4,"babel-runtime/core-js/object/create":5,"babel-runtime/core-js/object/get-prototype-of":7,"babel-runtime/core-js/object/keys":8,"babel-runtime/core-js/object/set-prototype-of":9,"babel-runtime/core-js/promise":10,"babel-runtime/core-js/reflect/construct":11,"babel-runtime/helpers/classCallCheck":14,"babel-runtime/helpers/createClass":15,"babel-runtime/helpers/inherits":16,"babel-runtime/helpers/possibleConstructorReturn":17,"es6-promise":118,"whatwg-fetch":120}],2:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(exports,"__esModule",{value:!0});var _promise=require("babel-runtime/core-js/promise"),_promise2=_interopRequireDefault(_promise),isReadyAsync=function(){return new _promise2.default(function(e){"interactive"===document.readyState||"complete"===document.readyState?e():(document.addEventListener("DOMContentLoaded",e,!1),window.addEventListener("load",e,!1))})};exports.default=isReadyAsync,module.exports=exports.default;
},{"babel-runtime/core-js/promise":10}],3:[function(require,module,exports){
module.exports={default:require("core-js/library/fn/array/from"),__esModule:!0};
},{"core-js/library/fn/array/from":19}],4:[function(require,module,exports){
...
},{"core-js/library/fn/object/create":21}],6:[function(require,module,exports){
...
},{"core-js/library/fn/object/get-prototype-of":23}],8:[function(require,module,exports){
...
module.exports={default:require("core-js/library/fn/reflect/construct"),__esModule:!0};
},{"core-js/library/fn/reflect/construct":27}],12:[function(require,module,exports){
...
},{"../core-js/object/create":5,"../core-js/object/set-prototype-of":9,"../helpers/typeof":18}],17:[function(require,module,exports){
...
},{"../../modules/_core":38,"../../modules/es6.array.from":103,"../../modules/es6.string.iterator":113}],20:[function(require,module,exports){
...
},{"../../modules/_core":38}],21:[function(require,module,exports){
...
},{"../../modules/_core":38,"../../modules/es6.object.create":105}],22:[function(require,module,exports){
...
},{"../../modules/_core":38,"../../modules/es6.object.define-property":106}],23:[function(require,module,exports){
require("../../modules/es6.object.get-prototype-of"),module.exports=require("../../modules/_core").Object.getPrototypeOf;
},{"../../modules/_core":38,"../../modules/es6.object.get-prototype-of":107}],24:[function(require,module,exports){
require("../../modules/es6.object.keys"),module.exports=require("../../modules/_core").Object.keys;
},{"../../modules/_core":38,"../../modules/es6.object.keys":108}],25:[function(require,module,exports){
require("../../modules/es6.object.set-prototype-of"),module.exports=require("../../modules/_core").Object.setPrototypeOf;
},{"../../modules/_core":38,"../../modules/es6.object.set-prototype-of":109}],26:[function(require,module,exports){
...
},{"../modules/_core":38,"../modules/es6.object.to-string":110,"../modules/es6.promise":111,"../modules/es6.string.iterator":113,"../modules/web.dom.iterable":117}],27:[function(require,module,exports){
require("../../modules/es6.reflect.construct"),module.exports=require("../../modules/_core").Reflect.construct;
},{"../../modules/_core":38,"../../modules/es6.reflect.construct":112}],28:[function(require,module,exports){
require("../../modules/es6.symbol"),require("../../modules/es6.object.to-string"),require("../../modules/es7.symbol.async-iterator"),require("../../modules/es7.symbol.observable"),module.exports=require("../../modules/_core").Symbol;
},{"../../modules/_core":38,"../../modules/es6.object.to-string":110,"../../modules/es6.symbol":114,"../../modules/es7.symbol.async-iterator":115,"../../modules/es7.symbol.observable":116}],29:[function(require,module,exports){
require("../../modules/es6.string.iterator"),require("../../modules/web.dom.iterable"),module.exports=require("../../modules/_wks-ext").f("iterator");
},{"../../modules/_wks-ext":100,"../../modules/es6.string.iterator":113,"../../modules/web.dom.iterable":117}],30:[function(require,module,exports){
...
},{"./_is-object":58}],34:[function(require,module,exports){
...
},{"./_to-index":92,"./_to-iobject":94,"./_to-length":95}],35:[function(require,module,exports){
...
},{"./_a-function":30,"./_invoke":54,"./_is-object":58}],36:[function(require,module,exports){
...
},{"./_object-dp":70,"./_property-desc":81}],40:[function(require,module,exports){
var aFunction=require("./_a-function");module.exports=function(n,r,t){if(aFunction(n),void 0===r)return n;switch(t){case 1:return function(t){return n.call(r,t)};case 2:return function(t,u){return n.call(r,t,u)};case 3:return function(t,u,e){return n.call(r,t,u,e)}}return function(){return n.apply(r,arguments)}};
},{"./_a-function":30}],41:[function(require,module,exports){
...
},{"./_object-gops":75,"./_object-keys":78,"./_object-pie":79}],46:[function(require,module,exports){
...
},{"./_core":38,"./_ctx":40,"./_global":49,"./_hide":51}],47:[function(require,module,exports){
...
},{"./_an-object":33,"./_ctx":40,"./_is-array-iter":56,"./_iter-call":59,"./_to-length":95,"./core.get-iterator-method":102}],49:[function(require,module,exports){
var global=module.exports="undefined"!=typeof window&&window.Math==Math?window:"undefined"!=typeof self&&self.Math==Math?self:Function("return this")();"number"==typeof __g&&(__g=global);
},{}],50:[function(require,module,exports){
var hasOwnProperty={}.hasOwnProperty;module.exports=function(r,e){return hasOwnProperty.call(r,e)};
},{}],51:[function(require,module,exports){
var dP=require("./_object-dp"),createDesc=require("./_property-desc");module.exports=require("./_descriptors")?function(e,r,t){return dP.f(e,r,createDesc(1,t))}:function(e,r,t){return e[r]=t,e};
},{"./_descriptors":42,"./_object-dp":70,"./_property-desc":81}],52:[function(require,module,exports){
...
},{"./_an-object":33}],60:[function(require,module,exports){
"use strict";var create=require("./_object-create"),descriptor=require("./_property-desc"),setToStringTag=require("./_set-to-string-tag"),IteratorPrototype={};require("./_hide")(IteratorPrototype,require("./_wks")("iterator"),function(){return this}),module.exports=function(r,t,e){r.prototype=create(IteratorPrototype,{next:descriptor(1,e)}),setToStringTag(r,t+" Iterator")};
},{"./_hide":51,"./_object-create":69,"./_property-desc":81,"./_set-to-string-tag":86,"./_wks":101}],61:[function(require,module,exports){
...
},{"./_export":46,"./_has":50,"./_hide":51,"./_iter-create":60,"./_iterators":64,"./_library":66,"./_object-gpo":76,"./_redefine":83,"./_set-to-string-tag":86,"./_wks":101}],62:[function(require,module,exports){
...
},{"./_object-keys":78,"./_to-iobject":94}],66:[function(require,module,exports){
module.exports=!0;
...
},{"./_fails":47,"./_has":50,"./_is-object":58,"./_object-dp":70,"./_uid":98}],68:[function(require,module,exports){
...
},{"./_cof":37,"./_global":49,"./_task":91}],69:[function(require,module,exports){
...
},{"./_an-object":33,"./_dom-create":43,"./_enum-bug-keys":44,"./_html":52,"./_object-dps":71,"./_shared-key":87}],70:[function(require,module,exports){
var anObject=require("./_an-object"),IE8_DOM_DEFINE=require("./_ie8-dom-define"),toPrimitive=require("./_to-primitive"),dP=Object.defineProperty;exports.f=require("./_descriptors")?Object.defineProperty:function(e,r,t){if(anObject(e),r=toPrimitive(r,!0),anObject(t),IE8_DOM_DEFINE)try{return dP(e,r,t)}catch(e){}if("get"in t||"set"in t)throw TypeError("Accessors not supported!");return"value"in t&&(e[r]=t.value),e};
},{"./_an-object":33,"./_descriptors":42,"./_ie8-dom-define":53,"./_to-primitive":97}],71:[function(require,module,exports){
var dP=require("./_object-dp"),anObject=require("./_an-object"),getKeys=require("./_object-keys");module.exports=require("./_descriptors")?Object.defineProperties:function(e,r){anObject(e);for(var t,o=getKeys(r),c=o.length,i=0;c>i;)dP.f(e,t=o[i++],r[t]);return e};
},{"./_an-object":33,"./_descriptors":42,"./_object-dp":70,"./_object-keys":78}],72:[function(require,module,exports){
var pIE=require("./_object-pie"),createDesc=require("./_property-desc"),toIObject=require("./_to-iobject"),toPrimitive=require("./_to-primitive"),has=require("./_has"),IE8_DOM_DEFINE=require("./_ie8-dom-define"),gOPD=Object.getOwnPropertyDescriptor;exports.f=require("./_descriptors")?gOPD:function(e,r){if(e=toIObject(e),r=toPrimitive(r,!0),IE8_DOM_DEFINE)try{return gOPD(e,r)}catch(e){}if(has(e,r))return createDesc(!pIE.f.call(e,r),e[r])};
},{"./_descriptors":42,"./_has":50,"./_ie8-dom-define":53,"./_object-pie":79,"./_property-desc":81,"./_to-iobject":94,"./_to-primitive":97}],73:[function(require,module,exports){
...
},{"./_enum-bug-keys":44,"./_object-keys-internal":77}],75:[function(require,module,exports){
exports.f=Object.getOwnPropertySymbols;
},{}],76:[function(require,module,exports){
var has=require("./_has"),toObject=require("./_to-object"),IE_PROTO=require("./_shared-key")("IE_PROTO"),ObjectProto=Object.prototype;module.exports=Object.getPrototypeOf||function(t){return t=toObject(t),has(t,IE_PROTO)?t[IE_PROTO]:"function"==typeof t.constructor&&t instanceof t.constructor?t.constructor.prototype:t instanceof Object?ObjectProto:null};
},{"./_has":50,"./_shared-key":87,"./_to-object":96}],77:[function(require,module,exports){
var has=require("./_has"),toIObject=require("./_to-iobject"),arrayIndexOf=require("./_array-includes")(!1),IE_PROTO=require("./_shared-key")("IE_PROTO");module.exports=function(r,e){var a,t=toIObject(r),u=0,O=[];for(a in t)a!=IE_PROTO&&has(t,a)&&O.push(a);for(;e.length>u;)has(t,a=e[u++])&&(~arrayIndexOf(O,a)||O.push(a));return O};
},{"./_array-includes":34,"./_has":50,"./_shared-key":87,"./_to-iobject":94}],78:[function(require,module,exports){
var $keys=require("./_object-keys-internal"),enumBugKeys=require("./_enum-bug-keys");module.exports=Object.keys||function(e){return $keys(e,enumBugKeys)};
},{"./_enum-bug-keys":44,"./_object-keys-internal":77}],79:[function(require,module,exports){
exports.f={}.propertyIsEnumerable;
},{}],80:[function(require,module,exports){
var $export=require("./_export"),core=require("./_core"),fails=require("./_fails");module.exports=function(e,r){var o=(core.Object||{})[e]||Object[e],t={};t[e]=r(o),$export($export.S+$export.F*fails(function(){o(1)}),"Object",t)};
},{"./_core":38,"./_export":46,"./_fails":47}],81:[function(require,module,exports){
...
},{"./_hide":51}],83:[function(require,module,exports){
...
},{"./_an-object":33,"./_ctx":40,"./_is-object":58,"./_object-gopd":72}],85:[function(require,module,exports){
...
},{"./_core":38,"./_descriptors":42,"./_global":49,"./_object-dp":70,"./_wks":101}],86:[function(require,module,exports){
var def=require("./_object-dp").f,has=require("./_has"),TAG=require("./_wks")("toStringTag");module.exports=function(e,r,o){e&&!has(e=o?e:e.prototype,TAG)&&def(e,TAG,{configurable:!0,value:r})};
},{"./_has":50,"./_object-dp":70,"./_wks":101}],87:[function(require,module,exports){
...
},{"./_a-function":30,"./_an-object":33,"./_wks":101}],90:[function(require,module,exports){
...
},{"./_cof":37,"./_ctx":40,"./_dom-create":43,"./_global":49,"./_html":52,"./_invoke":54}],92:[function(require,module,exports){
...
},{"./_core":38,"./_global":49,"./_library":66,"./_object-dp":70,"./_wks-ext":100}],100:[function(require,module,exports){
...
},{"./_classof":36,"./_core":38,"./_iterators":64,"./_wks":101}],103:[function(require,module,exports){
...
},{"./_create-property":39,"./_ctx":40,"./_export":46,"./_is-array-iter":56,"./_iter-call":59,"./_iter-detect":62,"./_to-length":95,"./_to-object":96,"./core.get-iterator-method":102}],104:[function(require,module,exports){
...
},{"./_add-to-unscopables":31,"./_iter-define":61,"./_iter-step":63,"./_iterators":64,"./_to-iobject":94}],105:[function(require,module,exports){
var $export=require("./_export");$export($export.S,"Object",{create:require("./_object-create")});
},{"./_export":46,"./_object-create":69}],106:[function(require,module,exports){
var $export=require("./_export");$export($export.S+$export.F*!require("./_descriptors"),"Object",{defineProperty:require("./_object-dp").f});
},{"./_descriptors":42,"./_export":46,"./_object-dp":70}],107:[function(require,module,exports){
...
},{"./_object-gpo":76,"./_object-sap":80,"./_to-object":96}],108:[function(require,module,exports){
var toObject=require("./_to-object"),$keys=require("./_object-keys");require("./_object-sap")("keys",function(){return function(e){return $keys(toObject(e))}});
},{"./_object-keys":78,"./_object-sap":80,"./_to-object":96}],109:[function(require,module,exports){
var $export=require("./_export");$export($export.S,"Object",{setPrototypeOf:require("./_set-proto").set});
},{"./_export":46,"./_set-proto":84}],110:[function(require,module,exports){
...
},{"./_a-function":30,"./_an-instance":32,"./_classof":36,"./_core":38,"./_ctx":40,"./_export":46,"./_for-of":48,"./_global":49,"./_is-object":58,"./_iter-detect":62,"./_library":66,"./_microtask":68,"./_redefine-all":82,"./_set-species":85,"./_set-to-string-tag":86,"./_species-constructor":89,"./_task":91,"./_wks":101}],112:[function(require,module,exports){
...
},{"./_a-function":30,"./_an-object":33,"./_bind":35,"./_export":46,"./_fails":47,"./_global":49,"./_is-object":58,"./_object-create":69}],113:[function(require,module,exports){
"use strict";var $at=require("./_string-at")(!0);require("./_iter-define")(String,"String",function(t){this._t=String(t),this._i=0},function(){var t,i=this._t,e=this._i;return e>=i.length?{value:void 0,done:!0}:(t=$at(i,e),this._i+=t.length,{value:t,done:!1})});
},{"./_iter-define":61,"./_string-at":90}],114:[function(require,module,exports){
...
},{"./_an-object":33,"./_descriptors":42,"./_enum-keys":45,"./_export":46,"./_fails":47,"./_global":49,"./_has":50,"./_hide":51,"./_is-array":57,"./_keyof":65,"./_library":66,"./_meta":67,"./_object-create":69,"./_object-dp":70,"./_object-gopd":72,"./_object-gopn":74,"./_object-gopn-ext":73,"./_object-gops":75,"./_object-keys":78,"./_object-pie":79,"./_property-desc":81,"./_redefine":83,"./_set-to-string-tag":86,"./_shared":88,"./_to-iobject":94,"./_to-primitive":97,"./_uid":98,"./_wks":101,"./_wks-define":99,"./_wks-ext":100}],115:[function(require,module,exports){
...
},{"./_global":49,"./_hide":51,"./_iterators":64,"./_wks":101,"./es6.array.iterator":104}],118:[function(require,module,exports){
